...
const DesignerViewPage = lazy(
  () => import("../pages/view/DesignerViewPage.tsx")
);
const DesignerPage = lazy(() => import("../pages/designer/DesignerPage.tsx"));
const GlobalMessage = lazy(
  () => import("../framework/message/GlobalMessage.tsx")
);
const GlobalModal = lazy(() => import("../framework/message/GlobalModal.tsx"));
const Login = lazy(() => import("../pages/login/Login"));
const Home = lazy(() => import("../pages/home/Home"));
const LocalProjectList = lazy(
  () => import("../pages/home/local-list/LocalProjectList.tsx")
);
const ServerProjectList = lazy(
  () => import("../pages/home/server-list/ServerProjectList.tsx")
);
const DataSourceList = lazy(
  () => import("../pages/home/datasource/DataSourceList.tsx")
);
const TemplateMarket = lazy(
  () => import("../pages/home/template-market/TemplateMarket.tsx")
);
